...
void cargar_campo(int campo[40][40]);
int movimientos(int campo[40][40],int *cont_vidas);
void bloques(int campo[40][40]);
void imprimr(int campo[40][40]);

int main(){
	
	int aux_fi,aux_co,campo[40][40],menu,opcion;
	char resp;
...
int movimientos(int campo[40][40],int *cont_vidas){
	...
	int fi,co,fi_1,co_1,tiempo,primera_vuelta,ban_1,valor,movimiento,ban,pisar;
	char tecla;
...
void cargar_campo(int campo[40][40]){//------------------ SOLO SE ACTIVA EN EL PRIMER NIVEL
